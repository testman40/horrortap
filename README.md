...
- 赤黒い手形が出たら、絶対にタップしない
- 取り逃してもミス扱いになる
- ミスが3回続くとゲームオーバー(振り向きかけの女性が近づいてくる演出が入ります)
...
これらの素材はコードとは別に、各生成AIツールの利用規約に従います。生成物の権利や商用利用可否は、利用したプラン(無料版 Gemini / Google Workspace with Gemini / Vertex AI 等)によって条件が異なります。本プロジェクトの素材を二次利用・改変・商用利用する場合は、必ず各ツールの最新の利用規約をご自身でご確認ください。
